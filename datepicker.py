...
class DatePicker(TextField):
    ...
    def init_ui(self):
        ...
        self.cal = CalendarWidget(as_popup=True, 
                                  touch_switch=self.touch_switch,size_hint=(1,1))
        # Popup
        self.popup = Pop(content=self.cal, on_dismiss=self.update_value, 
                           title="")
...
class MonthYearLabel(MDFlatButton):
    pass
...
class DayAbbrLabel(MDFlatButton):
    pass
...
class DayNumButton(MDFlatButton):
    pass

class DayNumWeekendButton(MDFlatButton):
    pass
