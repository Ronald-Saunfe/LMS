...
Builder.load_string('''
#:import md_icons icon_definitions.md_icons
...
<BaseRoundButton>:
    ...
    Label:
        id: content
        font_style: 'Icon'
        text: u"[font=materialdesignicons-webfont][size=24]{}[/size][/font]".format(md_icons[root.icon])
...
class BaseRaisedButton(BaseButton):
    '''
...
class MDRaisedButton(BaseRectangularButton,\
                     BaseRaisedButton, BasePressedButton):
    pass


class MDFloatingActionButton(BaseRoundButton,\
                             BaseRaisedButton):
